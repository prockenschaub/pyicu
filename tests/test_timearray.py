...
from pyicu.container.time import *
...
from pyicu.container.time import TimeDtype, TimeArray
...
def data(dtype):
    ...
    * data[0] and data[1] should not be equal
    """
    return TimeArray(np.arange(100), dtype)
...
def data_for_twos(dtype):
    ...
    """
    return TimeArray(np.array([2] * 100), dtype)
...
def data_for_sorting(dtype):
    ...
    """
    return TimeArray(np.array([2, 3, 1]), dtype)
...
def data_missing_for_sorting(dtype):
    ...
    """
    return TimeArray(np.array([2, np.nan, 1]), dtype)
...
def data_for_grouping(dtype):
    ...
    """
    return TimeArray(np.array([2, 2, np.nan, np.nan, 1, 1, 2, 3]), dtype)
