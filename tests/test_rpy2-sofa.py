...
sofa_score_ricu = ricu.load_concepts("sofa_score", "mimic_demo", verbose = rpy2.robjects.vectors.BoolVector([False]))
...
sofa_score_pyicu = concepts.load_concepts("sofa_score", mimic_demo)

# Print results from ricu and pyicu
print(sofa_score_ricu)
print(sofa_score_pyicu)